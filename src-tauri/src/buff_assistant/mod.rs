...
pub use model::{
    ...
    BuffAssistantSettings, BuffAssistantState, BuffOverlayColorScheme, BuffOverlayMode,
    BuffOverlayState, BuffTarget, CapturePreview, CaptureWindowCandidate, MAX_OVERLAY_HEIGHT,
